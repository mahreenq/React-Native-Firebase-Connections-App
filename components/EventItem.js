    ...
    return (
      <TouchableHighlight >
        <View style={styles.li}>
          ...
          {item.liked === true?  
          <Icon onPress={this.props.onLike}  name='ios-checkmark-circled' color="green" style={{padding:5}}/> : 
          <Icon onPress={this.props.onLike}  name='ios-checkmark' style={{padding:5}}/>
        }
